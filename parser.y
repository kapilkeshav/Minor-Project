...
%token<int_val> LPAREN RPAREN LBRACK RBRACK LBRACE RBRACE SEMI DOT COMMA EQ REFER
...
var_init : ID EQ constant

array_init: ID array EQ LBRACE values RBRACE ;
...
assigment: var_ref EQ expression ;
